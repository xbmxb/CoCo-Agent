...
def eval_for_metrics(args):
    ...
    text_correct = 0
    type_correct = 0
    # save the anno_pos as a dictionary: image -- annos
    ...
    for i, line in enumerate(tqdm(pred_data)):
        ...
        targets.append(pred_data[i]['ground_truth'])
        # reference_test_positions.append(data[i]['anno_pos'])
        if data[i]['image'] not in reference_test_positions.keys():
            reference_test_positions[data[i]['image']] = data[i]['anno_pos']
    ...
    for idx, pred in enumerate(preds):
        # eval for pretrain objective: 1. assert input in output, 2. compare the location
        reference = targets[idx]
        input_ = reference.split('[')[0] # the input prompt
        match_label = 0
        if pred['text'].startswith(input_):
            format_correct += 1
            reference_loc = reference.split(input_)[-1]
            reference_loc = eval(reference_loc)
            pred_loc = pred['text'].split(input_)[-1]
            pred_loc = eval(pred_loc)
            
            action_1_touch_yx = reference_loc
            action_1_lift_yx = reference_loc
            action_1_action_type = action_type.ActionType["DUAL_POINT"].value
            action_2_touch_yx = pred_loc
            action_2_lift_yx = pred_loc
            action_2_action_type = action_type.ActionType["DUAL_POINT"].value
            annotation_positions = reference_test_positions[pred['question_id']]
        ...
        action_data = {"pred": pred['text'], "target": reference, "match_label": match_label}
        output_data.append(action_data)
    metrics["format_acc"] = "{:.2f}".format(format_correct/len(targets) * 100)
    metrics["location_acc"] = "{:.2f}".format(location_correct/len(targets) * 100)
    metrics["format_correct"] = format_correct
    metrics["location_correct"] = location_correct
...
if __name__ == "__main__":
    ...
    parser.add_argument("--answers-file", type=str, default="/data/maxb/tag/LLaVA/llava/eval/res_out/pretv0_debug_llava_try-llama-2-7b-chat-finetune.jsonl")
    # parser.add_argument("--conv-mode", type=str, default="llava_llama_2")
    # parser.add_argument("--num-chunks", type=int, default=1)
    # parser.add_argument("--chunk-idx", type=int, default=0)
    # parser.add_argument("--answer-prompter", action="store_true")
    parser.add_argument("--prd_output_path", type=str, default='/data/maxb/tag/LLaVA/llava/eval/res_pret')
    parser.add_argument("--eval_name", type=str, default='pretv0_try')
...
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out/pretv0_debug_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret --eval_name pretv0_try

# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_55k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_55k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_60k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_60k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_45k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_45k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_35k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_35k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_40k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_40k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_50k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_50k

# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_80k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_80k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_85k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_85k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_90k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_90k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_95k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_95k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_100k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_100k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_105k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_105k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_110k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_110k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_115k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_115k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_120k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_120k
# python eval_aitw_pret.py --answers-file /data/maxb/tag/LLaVA/llava/eval/res_out_pretrain/pretv0_125k_llava_try-llama-2-7b-chat-finetune.jsonl --prd_output_path /data/maxb/tag/LLaVA/llava/eval/res_pret_scores --eval_name pretv0_125k
